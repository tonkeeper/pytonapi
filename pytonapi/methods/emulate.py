...
class EmulateMethod(AsyncTonapiClientBase):

    async def decode_message(self, body: Dict[str, Any]) -> DecodedMessage:
        """
    ...
    async def emulate_account_event(
            self,
            account_id: str,
            body: Dict[str, Any],
            accept_language: str = "en",
